...
class Plotter:
    ...
    def _build_title(self, figure:go.Figure, axis_titles:dict):
            ...
            figure.update_layout(title = {'text': self._extract_title_data(),
                                          'x': .50,
                                          'xanchor': 'center',
                                          },
                                 font = {'family': self._config[self._plot_type]['font_family'],
                                         'size': self._config[self._plot_type]['font_title']['size'],
                                         'color': self._config[self._plot_type]['font_title']['color'],
                                         },
    ...
    def _build_legend(self, figure:go.Figure):
        ...
        figure.update_layout(legend = {'x': 0.05,
                                       'y': 0.05,
                                       },
                             font = {'family': self._config[self._plot_type]['font_family'],
                                     'size': self._config[self._plot_type]['font_legend']['size'],
                                     'color': self._config[self._plot_type]['font_legend']['color'],
                                     },
                            )
