...
class Driver():
    def __init__(self, conf:config.Config, ticker:str, end_date:str, nmonths:int):
        self._conf = conf
        self._ticker = ticker
    ...
    def drive(self):
        ...
        with pd.option_context(
            ...
            #if conf.get_debug():
                #print('Objective function maxima:')
                #io_util.pretty_print(of.get_local_maxima())
